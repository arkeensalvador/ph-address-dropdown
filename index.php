...
<head>
    ...
    <meta name="keywords" content="Philippine address dropdown, dependent address dropdown">
    <meta name="description" content="Philippine address dropdown using JSON file in php">
